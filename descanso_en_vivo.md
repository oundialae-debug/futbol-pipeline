# Tarjetas al descanso -- 2026-09-21 01:58 UTC
...
*Consumo de API hoy: 66 llamadas en 5 pasadas, sobre un tope de 6000 (1%). El plan da 7.500 al día.*
...
**En juego, esperando al descanso:** Llaneros vs Atlético Nacional (min 42)


## Malacateco FC vs Mixco  (Liga Nacional)
*Half time · minuto 45 · 0 - 0 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**4 tarjetas** al descanso (minutos ['12', '25', '29', '45+1']). Esperadas en la 2ª parte: **2.4**.

*Sin mercado de tarjetas en vivo para este partido.*

## San Carlos vs CS Cartaginés  (Primera División)
*Half time · minuto 45 · 1 - 0 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**2 tarjetas** al descanso (minutos ['45+1', '45']). Esperadas en la 2ª parte: **2.54**.
