# Tarjetas al descanso -- 2026-09-23 01:55 UTC
...
*Consumo de API hoy: 30 llamadas en 5 pasadas, sobre un tope de 6000 (0%). El plan da 7.500 al día.*
...
## Santa Fe vs Deportivo Cali  (Primera A)
*Half time · minuto 45 · 0 - 1 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**1 tarjetas** al descanso (minutos ['30']) · **9 faltas**. Esperadas en la 2ª parte: **2.6**.
