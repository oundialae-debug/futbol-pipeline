# Tarjetas al descanso -- 2026-09-24 02:58 UTC
...
*Consumo de API hoy: 42 llamadas en 8 pasadas, sobre un tope de 6000 (1%). El plan da 7.500 al día.*
...
## Vancouver FC vs York 9 FC  (Canadian Premier League)
...
## Xelajú vs Antigua GFC  (Liga Nacional)
*Half time · minuto 45 · 2 - 0 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**2 tarjetas** al descanso (minutos ['39', '44']). Esperadas en la 2ª parte: **2.54**.
