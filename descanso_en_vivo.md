# Tarjetas al descanso -- 2026-09-24 09:54 UTC
...
*Consumo de API hoy: 117 llamadas en 29 pasadas, sobre un tope de 6000 (2%). El plan da 7.500 al día.*
...
## Ugyen Academy vs Drukpa  (Premier League)
...
## Laos vs Brunei  (FIFA Asean Cup)
*Half time · minuto 45 · 2 - 1 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**2 tarjetas** al descanso (minutos ['30', '33']) · **13 faltas**. Esperadas en la 2ª parte: **2.54**.
