# Tarjetas al descanso -- 2026-09-25 01:56 UTC
...
*Consumo de API hoy: 25 llamadas en 5 pasadas, sobre un tope de 6000 (0%). El plan da 7.500 al día.*
...
**En juego, esperando al descanso:** Mineros de Zacatecas vs Piratas (min 45)


## Alebrijes de Oaxaca vs CA La Paz  (Liga de Expansión MX)
*Half time · minuto 45 · 0 - 1 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**4 tarjetas** al descanso (minutos ['33', '35', '37', '44']) · **17 faltas**. Esperadas en la 2ª parte: **2.4**.
