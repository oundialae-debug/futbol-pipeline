# Tarjetas al descanso -- 2026-09-24 04:58 UTC
...
*Consumo de API hoy: 63 llamadas en 14 pasadas, sobre un tope de 6000 (1%). El plan da 7.500 al día.*
...
## Solomon Islands vs Vanuatu  (Friendlies)
*Half time · minuto 45 · 1 - 1 · nivel **(otras)**  ⚠ liga fuera del ajuste: se usa el nivel medio*

**1 tarjetas** al descanso (minutos ['41']). Esperadas en la 2ª parte: **2.6**.
