# Tarjetas al descanso -- 2026-09-25 00:47 UTC
...
*Consumo de API hoy: 9 llamadas en 2 pasadas, sobre un tope de 6000 (0%). El plan da 7.500 al día.*
...
**En juego, esperando al descanso:** Dominican Republic vs Nicaragua (min 45), Gualaceo SC vs Independiente del Valle (min 45), Everton de Vina vs Universidad de Chile (min 54)
