# Tarjetas al descanso -- 2026-09-20 11:23 UTC
...
*Consumo de API hoy: 436 llamadas en 20 pasadas, sobre un tope de 6000 (7%). El plan da 7.500 al día.*
...
**1 tarjetas** al descanso (minutos ['42']) · **8 faltas**. Esperadas en la 2ª parte: **3.35**.

| Línea | Modelo | Mercado | Casas | Mejor cuota | Valor |
|---|---|---|---|---|---|
| 1.5 | 95% | 62% | 2 | 1.71 (Vbet Sport) | +62.5% ⚠ revisar modelo |
| 2.0 (push 13%) | 82% | 76% | 1 | 1.22 (Vbet Sport) | +13.0% |
| 2.5 | 82% | 59% | 2 | 1.77 (Vbet Sport) | +44.4% ⚠ revisar modelo |
| 3.0 (push 19%) | 62% | 37% | 1 | 2.52 (Vbet Sport) | +76.1% ⚠ revisar modelo |
| 3.5 | 62% | 35% | 2 | 3.3 (Vbet Sport) | +105.1% ⚠ revisar modelo |
| 4.5 | 42% | 22% | 1 | 4.1 (Marathonbet) | +73.0% ⚠ revisar modelo |
| 5.5 | 26% | 13% | 1 | 7.0 (Marathonbet) | +80.8% ⚠ revisar modelo |
